...
describe('GameSprite - Basic Functionality', () => {
  ...
  it('should not render when not visible', () => {
    const { container } = render(<GameSprite {...defaultProps} isVisible={false} />)
  ...
  it('should handle puppy clicks', () => {
    ...
    const { container } = render(
      <GameSprite {...defaultProps} type="puppy" onPuppyClick={mockClick} />,
    )
  ...
  it('should not handle kitty clicks', () => {
    const mockClick = vi.fn()
    render(<GameSprite {...defaultProps} type="kitty" onPuppyClick={mockClick} />)
